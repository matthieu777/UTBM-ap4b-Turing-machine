...
public class BaseDeCartes {
    ...
    static {
        ...
        carte.put(4,new CarteCritere("     carte 4 ",new Critere(4)));
        carte.put(5,new CarteCritere("     carte 5 ",new Critere(5)));
        carte.put(6,new CarteCritere("     carte 6 ",new Critere(6)));
